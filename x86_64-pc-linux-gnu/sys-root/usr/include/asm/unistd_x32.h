...
#define __NR_SYNOUtime (__X32_SYSCALL_BIT + 402)
#define __NR_SYNOArchiveBit (__X32_SYSCALL_BIT + 403)
#define __NR_recvfile (__X32_SYSCALL_BIT + 404)
#define __NR_SYNOCaselessStat (__X32_SYSCALL_BIT + 406)
#define __NR_SYNOCaselessLStat (__X32_SYSCALL_BIT + 407)
#define __NR_SYNOEcryptName (__X32_SYSCALL_BIT + 410)
#define __NR_SYNODecryptName (__X32_SYSCALL_BIT + 411)
#define __NR_SYNOACLCheckPerm (__X32_SYSCALL_BIT + 412)
#define __NR_SYNOACLIsSupport (__X32_SYSCALL_BIT + 413)
#define __NR_SYNOACLGetPerm (__X32_SYSCALL_BIT + 414)
#define __NR_SYNOFlushAggregate (__X32_SYSCALL_BIT + 415)
#define __NR_SYNOStat (__X32_SYSCALL_BIT + 419)
#define __NR_SYNOFStat (__X32_SYSCALL_BIT + 420)
#define __NR_SYNOLStat (__X32_SYSCALL_BIT + 421)
#define __NR_SYNONotifyInit (__X32_SYSCALL_BIT + 422)
#define __NR_SYNOArchiveOverwrite (__X32_SYSCALL_BIT + 427)
