...
enum opt_code
{
  ...
  OPT_mno_align_stringops = 1139,            /* -mno-align-stringops */
  OPT_mno_default = 1140,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1141,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1142,                  /* -mno-push-args */
  OPT_mno_red_zone = 1143,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1144,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1145,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1146,                          /* -mpc32 */
  OPT_mpc64 = 1147,                          /* -mpc64 */
  OPT_mpc80 = 1148,                          /* -mpc80 */
  OPT_mpclmul = 1149,                        /* -mpclmul */
  OPT_mpopcnt = 1150,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1151,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1152,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1153,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1154,                        /* -mprfchw */
  OPT_mpush_args = 1155,                     /* -mpush-args */
  OPT_mrdrnd = 1156,                         /* -mrdrnd */
  OPT_mrdseed = 1157,                        /* -mrdseed */
  OPT_mrecip = 1158,                         /* -mrecip */
  OPT_mrecip_ = 1159,                        /* -mrecip= */
  OPT_mred_zone = 1160,                      /* -mred-zone */
  OPT_mregparm_ = 1161,                      /* -mregparm= */
  OPT_mrtd = 1162,                           /* -mrtd */
  OPT_mrtm = 1163,                           /* -mrtm */
  OPT_msahf = 1164,                          /* -msahf */
  OPT_msha = 1165,                           /* -msha */
  OPT_msoft_float = 1166,                    /* -msoft-float */
  OPT_msse = 1167,                           /* -msse */
  OPT_msse2 = 1168,                          /* -msse2 */
  OPT_msse2avx = 1169,                       /* -msse2avx */
  OPT_msse3 = 1170,                          /* -msse3 */
  OPT_msse4 = 1171,                          /* -msse4 */
  OPT_msse4_1 = 1172,                        /* -msse4.1 */
  OPT_msse4_2 = 1173,                        /* -msse4.2 */
  OPT_msse4a = 1174,                         /* -msse4a */
  /* OPT_msse5 = 1175, */                    /* -msse5 */
  OPT_msseregparm = 1176,                    /* -msseregparm */
  OPT_mssse3 = 1177,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1178,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1179,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1180,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1181,            /* -mstringop-strategy= */
  OPT_mtbm = 1182,                           /* -mtbm */
  OPT_mtls_dialect_ = 1183,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1184,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1185,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1186,                         /* -mtune= */
  OPT_muclibc = 1187,                        /* -muclibc */
  OPT_mveclibabi_ = 1188,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1189,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1190,                    /* -mvzeroupper */
  OPT_mx32 = 1191,                           /* -mx32 */
  OPT_mxop = 1192,                           /* -mxop */
  OPT_mxsave = 1193,                         /* -mxsave */
  OPT_mxsaveopt = 1194,                      /* -mxsaveopt */
  OPT_n = 1195,                              /* -n */
  OPT_no_canonical_prefixes = 1196,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1197,              /* -no-integrated-cpp */
  OPT_nocpp = 1198,                          /* -nocpp */
  OPT_nodefaultlibs = 1199,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1200,                   /* -nostartfiles */
  OPT_nostdinc = 1201,                       /* -nostdinc */
  OPT_nostdinc__ = 1202,                     /* -nostdinc++ */
  OPT_nostdlib = 1203,                       /* -nostdlib */
  OPT_o = 1204,                              /* -o */
  OPT_p = 1205,                              /* -p */
  OPT_pass_exit_codes = 1206,                /* -pass-exit-codes */
  /* OPT_pedantic = 1207, */                 /* -pedantic */
  OPT_pedantic_errors = 1208,                /* -pedantic-errors */
  OPT_pg = 1209,                             /* -pg */
  OPT_pie = 1210,                            /* -pie */
  OPT_pipe = 1211,                           /* -pipe */
  OPT_posix = 1212,                          /* -posix */
  OPT_print_file_name_ = 1213,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1214,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1215,          /* -print-multi-directory */
  OPT_print_multi_lib = 1216,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1217,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1218,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1219,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1220,               /* -print-prog-name= */
  OPT_print_search_dirs = 1221,              /* -print-search-dirs */
  OPT_print_sysroot = 1222,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1223,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1224,                        /* -profile */
  OPT_pthread = 1225,                        /* -pthread */
  OPT_quiet = 1226,                          /* -quiet */
  OPT_r = 1227,                              /* -r */
  OPT_rdynamic = 1228,                       /* -rdynamic */
  OPT_remap = 1229,                          /* -remap */
  OPT_s = 1230,                              /* -s */
  OPT_s_bc_abi = 1231,                       /* -s-bc-abi */
  OPT_save_temps = 1232,                     /* -save-temps */
  OPT_save_temps_ = 1233,                    /* -save-temps= */
  OPT_shared = 1234,                         /* -shared */
  OPT_shared_libgcc = 1235,                  /* -shared-libgcc */
  /* OPT_specs = 1236, */                    /* -specs */
  OPT_specs_ = 1237,                         /* -specs= */
  OPT_static = 1238,                         /* -static */
  OPT_static_libasan = 1239,                 /* -static-libasan */
  OPT_static_libgcc = 1240,                  /* -static-libgcc */
  OPT_static_libgcj = 1241,                  /* -static-libgcj */
  OPT_static_libgfortran = 1242,             /* -static-libgfortran */
  OPT_static_libgo = 1243,                   /* -static-libgo */
  OPT_static_liblsan = 1244,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1245,               /* -static-libstdc++ */
  OPT_static_libtsan = 1246,                 /* -static-libtsan */
  OPT_static_libubsan = 1247,                /* -static-libubsan */
  /* OPT_std_c__03 = 1248, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1249, */                /* -std=c++0x */
  OPT_std_c__11 = 1250,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1251, */                /* -std=c++14 */
  OPT_std_c__1y = 1252,                      /* -std=c++1y */
  ...
  OPT_std_gnu__98 = 1270,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1271,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1272, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1273, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1274,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1275,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1276, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1277, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1278,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1279, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1280, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1281, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1282,                     /* -std=legacy */
  OPT_symbolic = 1283,                       /* -symbolic */
  OPT_t = 1284,                              /* -t */
  OPT_time = 1285,                           /* -time */
  OPT_time_ = 1286,                          /* -time= */
  OPT_tno_android_cc = 1287,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1288,                 /* -tno-android-ld */
  OPT_traditional = 1289,                    /* -traditional */
  OPT_traditional_cpp = 1290,                /* -traditional-cpp */
  OPT_trigraphs = 1291,                      /* -trigraphs */
  OPT_u = 1292,                              /* -u */
  OPT_undef = 1293,                          /* -undef */
  OPT_v = 1294,                              /* -v */
  OPT_version = 1295,                        /* -version */
  OPT_w = 1296,                              /* -w */
  OPT_wrapper = 1297,                        /* -wrapper */
  OPT_x = 1298,                              /* -x */
  OPT_z = 1299,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
