...
__SYSCALL_COMMON(402, sys_SYNOUtime, sys_SYNOUtime)
__SYSCALL_COMMON(403, sys_SYNOArchiveBit, sys_SYNOArchiveBit)
__SYSCALL_COMMON(404, sys_recvfile, sys_recvfile)
__SYSCALL_COMMON(406, sys_SYNOCaselessStat, sys_SYNOCaselessStat)
__SYSCALL_COMMON(407, sys_SYNOCaselessLStat, sys_SYNOCaselessLStat)
__SYSCALL_COMMON(410, sys_SYNOEcryptName, sys_SYNOEcryptName)
__SYSCALL_COMMON(411, sys_SYNODecryptName, sys_SYNODecryptName)
__SYSCALL_COMMON(412, sys_SYNOACLCheckPerm, sys_SYNOACLCheckPerm)
__SYSCALL_COMMON(413, sys_SYNOACLIsSupport, sys_SYNOACLIsSupport)
__SYSCALL_COMMON(414, sys_SYNOACLGetPerm, sys_SYNOACLGetPerm)
__SYSCALL_COMMON(415, sys_SYNOFlushAggregate, sys_SYNOFlushAggregate)
__SYSCALL_COMMON(419, sys_SYNOStat, sys_SYNOStat)
__SYSCALL_COMMON(420, sys_SYNOFStat, sys_SYNOFStat)
__SYSCALL_COMMON(421, sys_SYNOLStat, sys_SYNOLStat)
__SYSCALL_COMMON(422, sys_SYNONotifyInit, sys_SYNONotifyInit)
__SYSCALL_64(423, sys_SYNONotifyAddWatch, sys_SYNONotifyAddWatch)
__SYSCALL_64(424, sys_SYNONotifyRemoveWatch, sys_SYNONotifyRemoveWatch)
__SYSCALL_COMMON(427, sys_SYNOArchiveOverwrite, sys_SYNOArchiveOverwrite)
