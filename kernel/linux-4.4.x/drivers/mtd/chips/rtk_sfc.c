...
#ifdef MY_DEF_HERE
static int rtk_sfc_unlock(struct mtd_info *mtd, loff_t ofs, uint64_t len)
{
	return 0;
}

static int rtk_sfc_lock(struct mtd_info *mtd, loff_t ofs, uint64_t len)
{
	return 0;
}
#endif /* MY_DEF_HERE */
...
#ifdef MY_DEF_HERE
	descriptor._lock    = rtk_sfc_lock;
	descriptor._unlock  = rtk_sfc_unlock;
#endif /* MY_DEF_HERE */
